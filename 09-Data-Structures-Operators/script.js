...
const restaurant = {
  ...
  orderDelivery({ starterIndex = 1, mainIndex = 0, time = '20:00', address }) {
    console.log(
      `Order received! ${this.starterMenu[starterIndex]} and ${this.mainMenu[mainIndex]} wiil be delivered to ${address} at ${time}.`
    );
  },
...
console.log('Anderson'.padStart(25, '+').padEnd(30,'-'));
...
console.log(maskCreditCard('1223548794651231'));
...
console.log('anderson'.toUpperCase());

// Fix Capitalization

const passenger = 'anDerSoN';
const passengerLower = passenger.toLowerCase();
const passengerCorrect =
  passengerLower[0].toUpperCase() + passengerLower.slice(1);
console.log(passengerCorrect);

const capitalization = function (firstName) {
...
if (plane.startsWith('Airbus') && plane.endsWith('neo')) {
  console.log('Plane of the NEW Airbus family');
}
...
// 4.
for(const [minute, event] of gameEvents.entries()){
  const half = minute < 46 ? '[FIRST HALF]' : '[SECOND HALF]';
...
question.get(answer) === 'JavaScript'
...
/////////////////////////////////////////////////
// Coding Challenges #1
// game.printGoals('Anderson', 'Barros', 'Rigonatto');
//.1
...
// Nullish: null and undefined (anu 0 or '')
